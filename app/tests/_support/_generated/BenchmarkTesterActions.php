...
trait BenchmarkTesterActions
{
     ...
     * @see \Helper\Benchmark::printBenchmarkResults()
     */
    public function printBenchmarkResults(string $name, array $results): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('printBenchmarkResults', func_get_args()));
    }
}
